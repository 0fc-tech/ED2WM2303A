...
class ArticleDaoMemoryImpl : IArticleDao {
    ...
    override fun getAll(): List<Article> {
        return listOf(
            Article(1, "Article 1", "Description de l'article 1", 29.99, "https://url1.com", true,3, LocalDate.now()),
            Article(2, "Article 2", "Description de l'article 2", 49.99, "https://url2.com", false,3, LocalDate.now()),
            Article(3, "Article 3", "Description de l'article 3", 9.99, "https://url3.com", true,3, LocalDate.now()),
            Article(4, "Article 4", "Description de l'article 4", 79.99, "https://url4.com", false,3, LocalDate.now()),
            Article(5, "Article 5", "Description de l'article 5", 99.99, "https://url5.com", true,3, LocalDate.now()),
            Article(6, "Article 6", "Description de l'article 6", 19.99, "https://url6.com", false,3, LocalDate.now()),
            Article(7, "Article 7", "Description de l'article 7", 39.99, "https://url7.com", true, 3,LocalDate.now()),
            Article(8, "Article 8", "Description de l'article 8", 59.99, "https://url8.com", false,3, LocalDate.now()),
